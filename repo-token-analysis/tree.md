...
```
      ...
      <file path="repo-token-analysis/badges/claude.svg">
        ```svg
...
```
      ...
      <file path="repo-token-analysis/badges/gemini.svg">
        ```svg
...
```
      ...
      <file path="repo-token-analysis/badges/gpt4.svg">
        ```svg
...
```
      ...
      <file path="repo-token-analysis/dependencies.md">
        ```md
...
```
      ...
      <file path="repo-token-analysis/history.json">
        ```json
[
  {
...
```
      ...
      <file path="repo-token-analysis/report.json">
        ```json
{
  "timestamp": "2026-02-17T16:07:27.610Z",
  "tokenizers": {
...
```
      ...
      <file path="repo-token-analysis/tree.md">
        ```md
<directory>workspace</directory>
